...
pygame.display.set_caption('THE RUSH')
...
pygame.mixer.music.load('music/carrun2.wav')
laugh = pygame.mixer.Sound('music/thuglifewav.wav')


# images
playerImage = pygame.image.load('image/car1.png')
car3 = pygame.image.load('image/car2.png')
car4 = pygame.image.load('image/car3.png')
playerRect = playerImage.get_rect()
baddieImage = pygame.image.load('image/savi.png')
